webpackJsonp([2,7],Array(471).concat([
/* 471 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_cards_cards_component__ = __webpack_require__(829);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_card_service__ = __webpack_require__(830);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__cards_routing__ = __webpack_require__(836);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_router__ = __webpack_require__(292);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_angular_in_memory_web_api__ = __webpack_require__(828);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__in_memory_data_service__ = __webpack_require__(825);
    ...
    CardsModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6__angular_router__["a" /* RouterModule */].forChild(__WEBPACK_IMPORTED_MODULE_5__cards_routing__["a" /* routes */]),
                __WEBPACK_IMPORTED_MODULE_7_angular_in_memory_web_api__["a" /* InMemoryWebApiModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__in_memory_data_service__["a" /* InMemoryDataService */]),
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__components_cards_cards_component__["a" /* CardsComponent */],
            ],
            providers: [
                __WEBPACK_IMPORTED_MODULE_4__services_card_service__["a" /* CardService */],
            ]
        }), 
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_delay__ = __webpack_require__(547);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__http_status_codes__ = __webpack_require__(559);
...
function createErrorResponse(req, status, message) {
    return new __WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */]({
        body: { 'error': "" + message },
        url: req.url,
...
function emitResponse(responseObserver, req, resOptions) {
    ...
    var res = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* Response */](resOptions);
...
var InMemoryBackendConfig = (function () {
    function InMemoryBackendConfig(config) {
        ...
        Object.assign(this, {
            ...
            defaultResponseOptions: new __WEBPACK_IMPORTED_MODULE_1__angular_http__["i" /* BaseResponseOptions */](),
            delay: 500,
            delete404: false,
...
var InMemoryBackendService = (function () {
    ...
    InMemoryBackendService.prototype.createConnection = function (req) {
        ...
        return {
            readyState: __WEBPACK_IMPORTED_MODULE_1__angular_http__["j" /* ReadyState */].Done,
            request: req,
            response: response
        };
    };
    ...
    InMemoryBackendService.prototype.handleRequest = function (req) {
        ...
        var reqMethodName = __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */][req.method || 0].toLowerCase();
        var resOptions;
    ...
    InMemoryBackendService.prototype.collectionHandler = function (reqInfo) {
        ...
        return new __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"](function (responseObserver) {
            var resOptions;
            switch (req.method) {
                case __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */].Get:
                    resOptions = _this.get(reqInfo);
                    break;
                case __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */].Post:
                    resOptions = _this.post(reqInfo);
                    break;
                case __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */].Put:
                    resOptions = _this.put(reqInfo);
                    break;
                case __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */].Delete:
    ...
    InMemoryBackendService.prototype.commands = function (reqInfo) {
        ...
        switch (command) {
            case 'resetdb':
                this.resetDb();
                resOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */]({ status: __WEBPACK_IMPORTED_MODULE_4__http_status_codes__["b" /* STATUS */].OK });
                break;
            case 'config':
                if (method === __WEBPACK_IMPORTED_MODULE_1__angular_http__["k" /* RequestMethod */].Get) {
                    resOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */]({
                    ...
                    this.setPassThruBackend();
                    resOptions = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */]({ status: __WEBPACK_IMPORTED_MODULE_4__http_status_codes__["b" /* STATUS */].NO_CONTENT });
                }
                break;
            default:
    ...
    InMemoryBackendService.prototype.post = function (_a) {
        ...
        if (existingIx > -1) {
            ...
            return new __WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */](res);
        }
        else {
            collection.push(item);
            headers.set('Location', resourceUrl + '/' + id);
            return new __WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */]({ headers: headers, body: body, status: __WEBPACK_IMPORTED_MODULE_4__http_status_codes__["b" /* STATUS */].CREATED });
        }
    };
    ...
    InMemoryBackendService.prototype.setPassThruBackend = function () {
        ...
        if (this.config.passThruUnknownUrl) {
            try {
                ...
                var browserXhr = this.injector.get(__WEBPACK_IMPORTED_MODULE_1__angular_http__["m" /* BrowserXhr */]);
                var baseResponseOptions = this.injector.get(__WEBPACK_IMPORTED_MODULE_1__angular_http__["h" /* ResponseOptions */]);
                var xsrfStrategy = this.injector.get(__WEBPACK_IMPORTED_MODULE_1__angular_http__["n" /* XSRFStrategy */]);
                this.passThruBackend = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* XHRBackend */](browserXhr, baseResponseOptions, xsrfStrategy);
            }
            catch (ex) {
    ...
    InMemoryBackendService.ctorParameters = function () { return [
        ...
        { type: InMemoryBackendConfigArgs, decorators: [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["r" /* Inject */], args: [InMemoryBackendConfig,] }, { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Optional */] },] },
    ]; };
...
var InMemoryDataService = (function () {
    ...
    InMemoryDataService.prototype.createDb = function () {
        ...
        return { wallets: wallets, cards: cards, currencies: currencies };
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__in_memory_backend_service__ = __webpack_require__(560);
    ...
    */
    ...
    InMemoryWebApiModule.decorators = [
        { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */], args: [{
                    ...
                    providers: [{ provide: __WEBPACK_IMPORTED_MODULE_1__angular_http__["g" /* XHRBackend */],
                            useFactory: inMemoryBackendServiceFactory,
                            deps: [__WEBPACK_IMPORTED_MODULE_0__angular_core__["X" /* Injector */], __WEBPACK_IMPORTED_MODULE_2__in_memory_backend_service__["b" /* InMemoryDbService */], __WEBPACK_IMPORTED_MODULE_2__in_memory_backend_service__["c" /* InMemoryBackendConfig */]] }]
                },] },
    ];
    /** @nocollapse */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__http_status_codes__ = __webpack_require__(559);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__in_memory_backend_service__ = __webpack_require__(560);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__in_memory_web_api_module__ = __webpack_require__(827);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_card_service__ = __webpack_require__(830);
...
var CardsComponent = (function () {
    ...
    CardsComponent.prototype.select = function (card) {
        card.selected = !card.selected;
    };
    // checking whether at least one card is selected
    CardsComponent.prototype.isSelected = function () {
    ...
    CardsComponent.prototype.delete = function () {
        for (var i = 0; i < this.cards.length; i++) {
            if (this.cards[i].selected) {
                this.cardsService.deleteCard(this.cards[i].id).subscribe(function () { });
    ...
    CardsComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_card_service__["a" /* CardService */] !== 'undefined' && __WEBPACK_IMPORTED_MODULE_1__services_card_service__["a" /* CardService */]) === 'function' && _a) || Object])
    ], CardsComponent);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_cards_cards_component__ = __webpack_require__(829);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return routes; });

var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_0__components_cards_cards_component__["a" /* CardsComponent */] }
];
...
module.exports = "<div class=\"cards\">\r\n  <div class=\"card\" *ngFor=\"let card of cards\" (click)=\"select(card)\" [class.selected]=\"card.selected\">\r\n    <div>{{ card.name }}</div>\r\n    <div>{{ card.balance }}</div>\r\n  </div>\r\n</div>\r\n<div class=\"delete\" (click)=\"delete()\" *ngIf=\"isSelected()\">Delete</div>\r\n\r\n<div class=\"no-cards\" *ngIf=\"!cards.length\">You have no cards:(</div>"
